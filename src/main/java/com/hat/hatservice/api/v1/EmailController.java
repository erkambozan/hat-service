...
public class EmailController {
	...
	@PostMapping(value = "/sendcode", produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
	@ResponseStatus(code = HttpStatus.CREATED)
	...
	@ResponseStatus(code = HttpStatus.CREATED)
	public Boolean verifyEmail(@RequestBody VerificationRequest request)
			throws Exception {
